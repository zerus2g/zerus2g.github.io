    ...
    a.fn.iframeAutoHeight = function (b) {
      ...
      function d(b, d) {
        ...
        try {
          c(
            "  " +
              a(b, window.parent).contents().find("body")[0].scrollHeight +
        ...
        this.each(function () {
          ...
          function e(e) {
            ...
            c(i),
              ...
              g.maxHeight > 0 &&
                i > g.maxHeight &&
                (c("new height is greater than maxHeight"), (i = g.maxHeight)),
              (i += g.heightOffset),
              c("New Height: " + i),
              g.animate
                ? a(e).animate({ height: i + "px" }, { duration: 500 })
                : (e.style.height = i + "px"),
          ...
          (h["default"] = function (a, b, c) {
            ...
            jQuery.each(g.heightCalculationOverrides, function (a, b) {
          ...
          if (a.browser.webkit || a.browser.opera || a.browser.chrome) {
            c("browser is webkit (Safari/Chrome) or opera"),
              a(this).load(function () {
                ...
                0 === i ? (a = 500) : (b.style.height = g.minHeight + "px"),
                  c("load delay: " + a),
                  setTimeout(d, a),
                  i++;
              });
