...
(function (N, I) {
  ...
  var I = (function () {
    var a =
      ...
      G =
        y &&
        y.createElementNS &&
        !!y.createElementNS("http://www.w3.org/2000/svg", "svg").createSVGRect,
  ...
  (function (a) {
    ...
    a.Fx.prototype = {
      ...
      update: function () {
        ...
        if (this[c + "Setter"]) this[c + "Setter"]();
          ...
          a.attr
            ? a.element && a.attr(c, p, null, !0)
            : (a.style[c] = p + this.unit);
        t && t.call(a, p, this);
      },
      run: function (k, c, p) {
        var t = this,
    ...
    a.pad = function (a, c, p) {
      return (
        Array((c || 2) + 1 - String(a).replace("-", "").length).join(p || 0) + a
      );
    };
    a.relativeLength = function (a, c, p) {
      return /%$/.test(a)
        ? (c * parseFloat(a)) / 100 + (p || 0)
        : parseFloat(a);
    };
    ...
    a.normalizeTickInterval = function (k, c, p, t, v) {
      ...
      for (
        ...
        t < c.length &&
        !((r = c[t]),
        (v && r * p >= k) || (!v && w <= (c[t] + (c[t + 1] || c[t])) / 2));
        t++
      );
      return (r = a.correctFloat(
        r * p,
    ...
    a.numberFormat = function (k, c, p, t) {
      ...
      -1 === c
        ...
        : (c = 2);
      h = (
        Math.abs(e[1] ? e[0] : k) + Math.pow(10, -Math.max(c, w) - 1)
      ).toFixed(c);
      w = String(a.pInt(h));
    ...
    a.animate = function (k, c, p) {
      ...
      a.isObject(p) ||
        ((h = arguments),
        (p = { duration: h[2], easing: h[3], complete: h[4] }));
  ...
  (function (a) {
    ...
    n(y.prototype, {
      ...
      complexColor: function (f, q, d) {
        ...
        a.fireEvent(
          ...
          function () {
            f.radialGradient
              ? (e = "radialGradient")
              : f.linearGradient && (e = "linearGradient");
            e &&
              ((n = f[e]),
              (J = C.gradients),
              (l = f.stops),
      ...
      applyTextOutline: function (f) {
        var C = this.element,
          ...
          e,
          m;
        -1 !== f.indexOf("contrast") &&
          (f = f.replace(/contrast/g, this.renderer.getContrast(C.style.fill)));
        f = f.split(" ");
        b = f[f.length - 1];
      ...
      align: function (a, f, q) {
        ...
        if (a) {
          if (
            ((this.alignOptions = a), (this.alignByTranslate = f), !q || E(q))
          )
      ...
      getBBox: function (a, f) {
        ...
        d = f * h;
        e = C.styledMode
          ? b && y.prototype.getStyle.call(b, "font-size")
          : g && g.fontSize;
        r(m) &&
          ((c = m.toString()),
        ...
        if (!q) {
          ...
          C.isSVG &&
            ...
            f &&
              ((q.width =
                Math.abs(C * Math.sin(d)) + Math.abs(a * Math.cos(d))),
              (q.height =
                Math.abs(C * Math.cos(d)) + Math.abs(a * Math.sin(d)))));
          if (c && 0 < q.height) {
        ...
        if (!a) this.destroyShadows();
          ...
          for (C = 1; C <= m; C++)
            (b = g.cloneNode(0)),
              ...
              q &&
                (c(b, "height", Math.max(c(b, "height") - e, 0)),
                (b.cutHeight = e)),
              f
                ? f.element.appendChild(b)
      ...
      titleSetter: function (a) {
        ...
        f ||
          ((f = l.createElementNS(this.SVG_NS, "title")),
          ...
          for (h = q.length - 1; 0 <= h && !C; h--)
            if (
              ...
              if (0 > a && n && !b && !h) g.insertBefore(m, q[h]), (C = !0);
                ...
                g.insertBefore(m, q[h + 1] || null), (C = !0);
    ...
    y.prototype.translateXSetter =
      ...
      y.prototype.matrixSetter =
        function (a, f) {
          this[f] = a;
          this.doTransform = !0;
        };
    y.prototype["stroke-widthSetter"] = y.prototype.strokeSetter = function (
      a,
      f,
      q
    ) {
    ...
    n(F.prototype, {
      ...
      init: function (a, f, q, b, d, g, e) {
        ...
        this.createElement("desc")
          .add()
          .element.appendChild(
            l.createTextNode("Created with Highcharts 7.0.3")
          );
      ...
      definition: function (a) {
        function f(a, b) {
          ...
          L(a).forEach(function (a) {
            ...
            g.add(b || q.defs);
            a.textContent &&
              g.element.appendChild(l.createTextNode(a.textContent));
            f(a.children || [], g);
            d = g;
          });
          return d;
          ...
          x = function (g, n) {
            ...
            if (void 0 === c[n])
              if (f.getSubStringLength)
                ...
                m.getSpanWidth &&
                  (r(e(q || b, g)), (c[n] = d + m.getSpanWidth(a, f)));
            return c[n];
          },
          u,
          D;
      ...
      buildText: function (a) {
        var q = a.element,
          ...
          H = function (a) {
            ...
            return r
              ? f(r)
              : b.fontMetrics(g, a.getAttribute("style") ? a : q).h;
          },
          E = function (a, f) {
      ...
      arc: function (a, f, q, b, g, d) {
        H(a)
          ? ((b = a), (f = b.y), (q = b.r), (a = b.x))
          : (b = { innerR: b, start: g, end: d });
      ...
      rect: function (a, f, q, b, g, d) {
        ...
        a = H(a)
          ...
          : void 0 === a
          ? {}
          : { x: a, y: f, width: Math.max(q, 0), height: Math.max(b, 0) };
        this.styledMode ||
          (void 0 !== d && ((a.strokeWidth = d), (a = e.crisp(a))),
          (a.fill = "none"));
        g && (a.r = g);
      ...
      symbol: function (a, f, q, b, g, d) {
        var e = this,
          ...
          c =
            r(f) &&
            x &&
            x.call(this.symbols, Math.round(f), Math.round(q), b, g, d),
          C,
          u;
        x
          ? ((m = this.path(c)),
        ...
        callout: function (a, f, q, b, g) {
          ...
          m && m > q
            ...
            : g &&
              ...
              m > a + e &&
              m < a + q - e &&
              n.splice(3, 3, "L", m - 6, f, m, f - 6, m + 6, f, q - d, f);
          return n;
        },
      },
      ...
      label: function (f, b, g, d, e, h, J, z, x) {
        ...
        U = function () {
          var a = D.element.style,
            f = {};
          L =
            (void 0 === M || void 0 === k || T) && r(D.textStr) && D.getBBox();
          u.width = (M || L.width || 0) + 2 * A + B;
          u.height = (k || L.height || 0) + 2 * A;
          t =
            A +
            Math.min(
              l.fontMetrics(a && a.fontSize, D).b,
              L ? L.height : Infinity
            );
          v &&
            (K ||
        ...
        O = function () {
          ...
          r(M) &&
            L &&
            ("center" === T || "right" === T) &&
            (a += { center: 0.5, right: 1 }[T] * (M - L.width));
          if (a !== D.x || f !== D.y)
            D.attr("x", a),
              D.hasBoxWidthChanged && ((L = D.getBBox(!0)), U()),
              void 0 !== f && D.attr("y", f);
          D.x = a;
          D.y = f;
        };
        ...
        u.xSetter = function (a) {
          u.x = a;
          C &&
            ((a -= C * ((M || L.width) + 2 * A)), (u["forceAnimate:x"] = !0));
          E = Math.round(a);
          u.attr("translateX", E);
        };
  ...
  (function (a) {
    ...
    c(h.prototype, {
          ...
          if ("SPAN" === d.tagName) {
            ...
            D !== this.cTT &&
              ...
              !k(B) ||
                ...
                this.setSpanRotation(B, c, m),
              this.getSpanCorrection(
                (!k(B) && this.textPxLength) || d.offsetWidth,
                m,
                c,
                B,
                l
      ...
      setSpanRotation: function (a, d, g) {
        ...
        b[e + (p ? "Origin" : "-origin")] = b.transformOrigin =
          100 * d + "% " + g + "px";
        G(this.element, b);
      },
    ...
    c(e.prototype, {
      ...
      html: function (e, d, g) {
        ...
        b.attr({ text: e, x: Math.round(d), y: Math.round(g) }).css({
          position: "absolute",
        });
        B ||
          b.css({
      ...
      makeTime: function (c, p, w, r, h, e) {
        ...
        this.useUTC
          ? ((l = this.Date.UTC.apply(0, arguments)),
            ...
            n !== d
              ? (l += d - n)
              : n - 36e5 !== this.getTimezoneOffset(l - 36e5) ||
                a.isSafari ||
                (l -= 36e5))
          : (l = new this.Date(
              c,
      ...
      getTimeTicks: function (a, p, w, r) {
        ...
        if (y(p)) {
          h.set(
            "Milliseconds",
            l,
            g >= c.second ? 0 : b * Math.floor(h.get("Milliseconds", l) / b)
          );
          g >= c.second &&
            h.set(
              "Seconds",
              l,
              g >= c.minute ? 0 : b * Math.floor(h.get("Seconds", l) / b)
            );
          g >= c.minute &&
            h.set(
              "Minutes",
              l,
              g >= c.hour ? 0 : b * Math.floor(h.get("Minutes", l) / b)
            );
          g >= c.hour &&
            h.set(
              "Hours",
              l,
              g >= c.day ? 0 : b * Math.floor(h.get("Hours", l) / b)
            );
          g >= c.day &&
            h.set(
              "Date",
              ...
              g >= c.month
                ? 1
                : Math.max(1, b * Math.floor(h.get("Date", l) / b))
            );
          g >= c.month &&
            (h.set(
              "Month",
              l,
              g >= c.year ? 0 : b * Math.floor(h.get("Month", l) / b)
            ),
            (d = h.get("FullYear", l)));
          ...
          h.variableTimezone &&
            (x =
              w - p > 4 * c.month ||
              h.getTimezoneOffset(p) !== h.getTimezoneOffset(w));
          p = l.getTime();
          for (l = 1; p < w; )
            e.push(p),
              (p =
  ...
  (function (a) {
    ...
    a.Tick.prototype = {
      addLabel: function () {
        ...
        r.isDatetimeAxis &&
          b &&
          ((B = e.time.resolveDTLFormat(
            h.dateTimeLabelFormats[(!h.grid && b.higherRanks[d]) || b.unitName]
          )),
          (E = B.main));
        c.isFirst = x;
        c.isLast = u;
        ...
        if ((z = B && B.list))
          c.shortenLabel = function () {
            for (m = 0; m < z.length; m++)
              if (
                (k.attr({
                  text: r.labelFormatter.call(
                    a.extend(c.formatCtx, { dateTimeLabelFormat: z[m] })
                  ),
                }),
        ...
        if (F(k))
          ...
          if (
            (c.label = k =
              F(h) && g.enabled
                ? e.renderer.text(h, 0, 0, g.useHTML).add(r.labelGroup)
                : null)
          )
      ...
      handleOverflow: function (a) {
        var c = this.axis,
          ...
          n = t(
            c.labelRight,
            Math.max(c.isRadial ? 0 : c.pos + c.len, l - n[1])
          ),
          g = this.label,
          b = this.rotation,
        ...
        c = {
          x: c
            ...
            : l.left +
              l.offset +
              (l.opposite
                ? ((e && n.oldChartWidth) || n.chartWidth) - l.right - l.left
                : 0),
          y: c
      ...
      renderGridLine: function (a, c, h) {
        ...
        n ||
          (e.chart.styledMode ||
            ((d.stroke = B), (d["stroke-width"] = k), l && (d.dashstyle = l)),
          b || (d.zIndex = 1),
          a && (c = 0),
          (this.gridLine = n =
            u
  ...
  var X = (function (a) {
    ...
    a.extend(A.prototype, {
      ...
      init: function (a, q) {
        ...
        b.crosshair = E(
          g.crosshair,
          m(a.options.tooltip.crosshairs)[f ? 0 : 1],
          !1
        );
        q = b.options.events;
        -1 === a.axes.indexOf(b) &&
          (f ? a.axes.splice(a.xAxis.length, 0, b) : a.axes.push(b),
          a[b.coll].push(b));
        b.series = b.series || [];
        a.inverted &&
          !b.isZAxis &&
          ...
          a.series.forEach(function (f) {
            if (f.visible || !q.options.chart.ignoreHiddenSeries) {
              ...
              if (a.isXAxis)
                ...
                v(f) &&
                  v(e) &&
                  ((a.dataMin = Math.min(E(a.dataMin, f), f)),
      ...
      getPlotLinePath: function (a, q, b, d, m) {
        ...
        e(this, "getPlotLinePath", A, function (e) {
          ...
          e.path =
            k && !d
              ? null
              : h.renderer.crispLine(["M", u, l, "L", z, x], q || 1);
        });
        return A.path;
      },
        ...
        if (h && h / g < a.len / 3)
          if (a.isLog)
            this.paddedTicks.forEach(function (f, q, b) {
              q &&
                d.push.apply(d, a.getLogTickPositions(g, b[q - 1], b[q], !0));
            });
      ...
      nameToX: function (a) {
        ...
        void 0 !== e &&
          ((this.names[e] = a.name), (this.names.keys[a.name] = e));
        return e;
      },
          ...
          (this.series || []).forEach(function (f) {
            ...
            f.data.forEach(function (q, b) {
              ...
              q &&
                ...
                void 0 !== q.name &&
                ((g = a.nameToX(q)),
                void 0 !== g && g !== q.x && ((q.x = g), (f.xData[b] = g)));
            });
          }));
      },
      ...
      setTickInterval: function (f) {
        ...
        b.range &&
          v(b.max) &&
          ((b.userMin = b.min = y = Math.max(b.dataMin, b.minFromRange())),
          (b.userMax = G = b.max),
          (b.range = null));
        e(b, "foundExtremes");
        ...
        g(m.floor) &&
          (b.min = Math.min(Math.max(b.min, m.floor), Number.MAX_VALUE));
        g(m.ceiling) &&
          (b.max = Math.max(
            Math.min(b.max, m.ceiling),
            E(b.userMax, -Number.MAX_VALUE)
          ));
        w &&
          v(b.dataMin) &&
          ((H = H || 0),
          !v(y) && b.min < H && b.dataMin >= H
            ? (b.min = H)
            : !v(G) && b.max > H && b.dataMax <= H && (b.max = H));
        b.tickInterval =
      ...
      setAxisSize: function () {
        var f = this.chart,
          ...
          e = (this.width = Math.round(
            a.relativeLength(E(b.width, f.plotWidth - g[3] + g[1]), f.plotWidth)
          )),
          m = (this.height = Math.round(
            a.relativeLength(
              E(b.height, f.plotHeight - g[0] + g[2]),
              f.plotHeight
            )
          )),
          h = (this.top = Math.round(
            a.relativeLength(
              E(b.top, f.plotTop + g[0]),
              f.plotHeight,
              f.plotTop
            )
          )),
      ...
      unsquish: function () {
        var a = this.options.labels,
          ...
          d = g,
          e =
            this.len / (((this.categories ? 1 : 0) + this.max - this.min) / g),
          m,
          h = a.rotation,
          n = this.labelMetrics(),
          c,
        ...
        b
          ? (z =
              ...
              (v(h)
                ? [h]
                : e < E(a.autoRotationLimit, 80) && a.autoRotation)) &&
          ...
          for (r = "clip", u = d.length; !n && u--; )
            if (((A = d[u]), (A = e[A].label)))
              A.styles && "ellipsis" === A.styles.textOverflow
                ...
                A.getBBox().height > this.len / d.length - (l.h - l.f) &&
                  (A.specificTextOverflow = "ellipsis");
        z.rotation &&
          ((D = k > 0.5 * a.chartHeight ? 0.33 * a.chartHeight : k),
          x || (r = "ellipsis"));
        if (
          ...
          f &&
            ...
            a.shortenLabel
              ...
              : D &&
                !b &&
                "nowrap" !== h.whiteSpace &&
                (D < f.textPxLength || "SPAN" === f.element.tagName)
              ? ((g.width = D),
      ...
      getOffset: function () {
        ...
        k &&
          ...
          l &&
            !1 !== k.reserveSpace &&
            ((a.titleOffset = x =
              a.axisTitle.getBBox()[n ? "height" : "width"]),
            (D = k.offset),
        ...
        a.getMaxLabelDimensions &&
          (a.maxLabelDimensions = a.getMaxLabelDimensions(h, m));
        n = this.tickSize("tick");
        p[c] = Math.max(
          p[c],
          a.axisTitleMargin + x + w * a.offset,
          r,
          z && m.length && n ? n[0] + w * a.offset : 0
        );
      ...
      render: function () {
        ...
        if (b.hasData() || n)
          b.minorTickInterval &&
            ...
            c.length &&
              ...
              B &&
                (0 === b.min || b.single) &&
                (l[-1] || (l[-1] = new D(b, -1, null, !0)), l[-1].render(-1))),
            A &&
        ...
        u &&
          ...
          g(m.y)
            ? (u[u.isNew ? "attr" : "animate"](m), (u.isNew = !1))
            ...
            this.chart.styledMode ||
              (h
                .attr({
                  stroke:
                    g.color ||
                    (d ? c("#ccd6eb").setOpacity(0.25).get() : "#cccccc"),
  ...
  (function (a) {
    ...
    y.prototype.normalizeTimeTickInterval = function (a, p) {
      ...
      for (
        ...
        (v = k[p[0]]),
        (w = p[1]),
        c[r + 1] && a <= (v * w[w.length - 1] + k[c[r + 1][0]]) / 2);
        r++
      );
  ...
  (function (a) {
    ...
    y.prototype.getLogTickPositions = function (a, p, t, v) {
      ...
      if (0.5 <= a)
        (a = Math.round(a)), (h = this.getLinearTickPositions(a, p, t));
      else if (0.08 <= a)
        for (
          var r = Math.floor(p),
            e,
        ...
        (p = this.lin2log(p)),
          ...
          (a = k(
            ...
            ((c.tickPixelInterval / (v ? 5 : 1)) * (t - p)) /
              ((v ? r / this.tickPositions.length : r) || 1)
          )),
          (a = G(a, null, F(a))),
  ...
  (function (a, y) {
    ...
    a.extend(y.prototype, {
      getPlotBandPath: function (a, c) {
        ...
        if (e && h)
          for (
            a && ((g = e.toString() === h.toString()), (d = 0)), a = 0;
            a < e.length;
            a += 6
          )
            n && h[a + 1] === e[a + 1]
    ...
    a.Tooltip.prototype = {
      ...
      getAnchor: function (a, c) {
        ...
        this.followPointer && c
          ? (void 0 === c.chartX && (c = h.normalize(c)),
            (a = [c.chartX - e.plotLeft, c.chartY - d]))
          : a[0].tooltipPos
          ? (a = a[0].tooltipPos)
      ...
      getPosition: function (a, c, e) {
        var h = this.chart,
          ...
          A = function (a, b, f, g) {
            ...
            g < n || g > b - n
              ? (e = !1)
              : (d[a] = g < f / 2 ? 1 : g > b - f / 2 ? b - f - 2 : g - f / 2);
            return e;
          },
          f = function (a) {
            var f = B;
              ...
              this.split
                ...
                : ((l.style.width && !k) ||
                  ...
                  e
                    ...
                    .addClass(
                      "highcharts-color-" + p(d.colorIndex, u.colorIndex)
                    ),
                  k ||
                    e.attr({
      ...
      renderSplit: function (c, h) {
        ...
        c.slice(0, h.length + 1).forEach(function (a, m) {
          if (!1 !== a && "" !== a) {
              ...
              (c.tt = D =
                d
                  .label(
                    ...
                    null,
                    null,
                    (m.isHeader ? b.headerShape : b.shape) || "callout",
                    null,
                    null,
                    b.useHTML
                  )
            ...
            0 > A && (g = !1);
            a =
              (m.series && m.series.yAxis && m.series.yAxis.pos) +
              (m.plotY || 0);
            a -= r;
        ...
        l.forEach(function (a) {
          ...
          a.tt.attr({
            ...
            x:
              g || d.isHeader || b.positioner
                ? a.x
                : d.plotX + n.plotLeft + e.distance,
            y: a.pos + r,
      ...
      updatePosition: function (a) {
        var c = this.chart,
          e = this.getLabel(),
          l = (this.options.positioner || this.getPosition).call(
            this,
            e.width,
            e.height,
            a
      ...
      getXDateFormat: function (a, c, e) {
        ...
        return (
          (h ? this.getDateFormat(h, a.x, e.options.startOfWeek, c) : c.day) ||
          c.year
        );
      },
      ...
      bodyFormatter: function (a) {
        return a.map(function (a) {
          ...
          return (
            e[(a.point.formatPrefix || "point") + "Formatter"] ||
    ...
    a.Pointer.prototype = {
          ...
          b && !b.stickyTracking
            ...
            : d.filter(function (a) {
                return (
                  a.visible &&
                  !(!c && a.directTouch) &&
                  l(a.options.enableMouseTracking, !0) &&
                  a.stickyTracking
                );
              });
      ...
      runPointActions: function (g, b) {
        var d = this.chart,
          ...
          n = this.getHoverData(
            ...
            d.series,
            "touchmove" !== g.type &&
              (!!b || (n && n.directTouch && this.isDirectTouch)),
            c,
            g
          ),
          m,
        ...
        if (h && (h !== d.hoverPoint || (e && e.isHidden))) {
          ...
          b &&
            ...
            !e.isHidden &&
            ((h = e.getAnchor([{}], g)),
            e.updatePosition({ plotX: h[0], plotY: h[1] }));
        this.unDocMouseMove ||
          ...
          10 < this.hasDragged &&
            ...
            b.hasCartesianSeries &&
              ...
              b.styledMode ||
                q.attr({
                  fill:
                    g.selectionMarkerFill ||
                    k("#335cad").setOpacity(0.25).get(),
                })),
            q &&
              c &&
              ((d -= r),
              q.attr({ width: Math.abs(d), x: (0 < d ? 0 : d) + r })),
            q &&
              h &&
              ((d = e - p),
              q.attr({ height: Math.abs(d), y: (0 < d ? 0 : d) + p })),
      ...
      setDOMEvents: function () {
        ...
        this.unbindContainerMouseLeave = y(
          b,
          "mouseleave",
          d.onContainerMouseLeave
        );
        a.unbindDocumentMouseUp ||
          (a.unbindDocumentMouseUp = y(e, "mouseup", d.onDocumentMouseUp));
        a.hasTouch &&
          ...
          a.unbindDocumentTouchEnd ||
            (a.unbindDocumentTouchEnd = y(
              e,
              "touchend",
              d.onDocumentTouchEnd
            )));
      },
      destroy: function () {
        var d = this;
  ...
  (function (a) {
    ...
    F(a.Pointer.prototype, {
      ...
      pinchTranslateDirection: function (a, k, t, v, w, r, h, e) {
        ...
        k < m.min
          ? ((k = m.min), (L = !0))
          : k + u > m.max && ((k = m.max - u), (L = !0));
        L
          ? ((A -= 0.8 * (A - h[n][0])), z || (q -= 0.8 * (q - h[n][1])), t())
          : (h[n] = [A, q]);
        B || ((r[n] = p - x), (r[b] = u));
        r = B ? 1 / E : E;
        w[b] = u;
      ...
      pinch: function (a) {
        var c = this,
          ...
          d =
            1 === r &&
            ((c.inClass(a.target, "highcharts-tracker") && t.runTrackerClick) ||
              c.runChartClick),
          g = {};
        1 < r && (c.initiated = !0);
        ...
        "touchstart" === a.type
          ...
          : v.length &&
            (l ||
              (c.selectionMarker = l = F({ destroy: G, touch: !0 }, t.plotBox)),
      ...
      touch: function (c, p) {
        ...
        1 === c.touches.length
          ? ((c = this.normalize(c)),
            (w = t.isInsidePlot(c.chartX - t.plotLeft, c.chartY - t.plotTop)) &&
            !t.openMenu
              ? (p && this.runPointActions(c),
                "touchmove" === c.type &&
                  ...
                  (v = p[0]
                    ? 4 <=
                      Math.sqrt(
                        Math.pow(p[0].chartX - c.chartX, 2) +
                          Math.pow(p[0].chartY - c.chartY, 2)
                      )
                    : !1)),
                k(v, !0) && this.pinch(c))
              : p && this.reset())
  ...
  (function (a) {
    ...
    a.Legend.prototype = {
      ...
      colorizeItem: function (a, d) {
        ...
        if (!this.chart.styledMode) {
          ...
          h &&
            (k &&
              h.isMarker &&
              ((m = a.pointAttribs()), d || (m.stroke = m.fill = n)),
            h.attr(m));
        }
      ...
      setText: function (e) {
        ...
        e.legendItem.attr({
          text: d.labelFormat
            ? a.format(d.labelFormat, e, this.chart.time)
      ...
      renderItem: function (a) {
        ...
        a.itemWidth = a.checkboxOffset =
          b.itemWidth || a.legendItemWidth || d.width + k;
      ...
      layoutItem: function (a) {
        var d = this.options,
          ...
          d =
            d.alignColumns && this.totalItemWidth > k
              ? this.maxItemWidth
              : a.itemWidth;
        b &&
          this.itemX - e + d > k &&
        ...
        b
          ? (this.itemX += d)
          : ((this.itemY += n + c + h), (this.lastLineHeight = c));
        this.offsetWidth =
          this.widthOption ||
          Math.max(
            (b ? this.itemX - e - (a.checkbox ? 0 : l) : d) + e,
            this.offsetWidth
          );
      },
      ...
      adjustMargins: function (a, d) {
        var e = this.chart,
          ...
          c = this.getAlignment(),
          h =
            void 0 !== e.options.title.margin
              ? e.titleOffset + e.options.title.margin
              : 0;
        c &&
          [
            /(lth|ct|rth)/,
      ...
      proximatePositions: function () {
        ...
        this.allItems.forEach(function (b) {
          ...
          b.xAxis &&
            ...
            (c = a.find(
              c ? b.points : b.points.slice(0).reverse(),
              function (b) {
            ...
            d.push({
              target: b.visible
                ? (c ? c.plotY : b.xAxis.height) - 0.3 * h
                : e.plotHeight,
              size: h,
              item: b,
            }));
      ...
      handleOverflow: function (a) {
        ...
        a > h && !1 !== z.enabled
          ? ((this.clipHeight = k = Math.max(h - 20 - this.titleHeight - n, 0)),
            ...
            m ||
              ((m = d.clipRect = b.clipRect(0, n, 9999, 0)),
  ...
  (function (a) {
    ...
    l(T.prototype, {
      ...
      initSeries: function (b) {
        ...
        (d = f[b.type || d.type || d.defaultSeriesType]) ||
          a.error(17, !0, this);
        d = new d();
        d.init(this, b);
        return d;
      ...
      setTitle: function (a, b, f) {
        ...
        c = e.title = E(
          !g && {
            style: { color: "#333333", fontSize: e.isStock ? "16px" : "18px" },
          },
          e.title,
          a
        );
      ...
      layOutTitles: function (a) {
        ...
        ["title", "subtitle"].forEach(function (a) {
          ...
          f &&
            ...
            f
              .css({ width: (g.width || e.width + g.widthAdjust) + "px" })
              .align(l({ y: a + c }, g), !1, "spacingBox"),
            g.floating ||
              g.verticalAlign ||
              (b = Math.ceil(b + f.getBBox(g.useHTML).height)));
        }, this);
        ...
        if (b)
          for (; f && f.style; )
            f.hcOrigStyle && (a.css(f, f.hcOrigStyle), delete f.hcOrigStyle),
              f.hcOrigDetached &&
                (c.body.removeChild(f), (f.hcOrigDetached = !1)),
              (f = f.parentNode);
        else
          for (; f && f.style; ) {
            c.body.contains(f) ||
              f.parentNode ||
              ((f.hcOrigDetached = !0), c.body.appendChild(f));
      ...
      setChartSize: function (a) {
        ...
        this.plotHeight = z = Math.max(
          0,
          Math.round(g - l - this.marginBottom)
        );
        ...
        this.clipBox = {
          ...
          height: Math.max(
            0,
            Math.floor(this.plotSizeY - Math.max(e, h[2]) / 2 - f)
          ),
        };
        a ||
      ...
      drawChartBox: function () {
        ...
        q ||
          ...
          k &&
            (l
              ? l.animate(p)
              : (this.plotBGImage = b.image(k, u, r, A, x).add())));
        B
      ...
      optionsToObject: function (e) {
        ...
        if (t(e) || null === e) c[g[0]] = e;
          ...
          for (
            ...
            (d && void 0 === e[k]) ||
              (0 < g[u].indexOf(".")
                ? a.Point.prototype.setNestedProperty(c, e[k], g[u])
                : (c[g[u]] = e[k])),
              k++,
              u++;
        else
    ...
    a.Series = a.seriesType(
      ...
      },
      {
        ...
        processData: function (b) {
          ...
          for (l = d.length || 1; --l; )
            (c = r ? k(d[l]) - k(d[l - 1]) : d[l] - d[l - 1]),
              0 < c && (void 0 === h || c < h)
                ? (h = c)
                : 0 > c && x && (a.error(15, !1, this.chart), (x = !1));
          this.cropped = g;
          this.cropStart = f;
          ...
          for (t = 0; t < l; t++)
            (n = k + t),
              x
                ...
                : (p = d[n]) ||
                  void 0 === b[n] ||
                  (d[n] = p = new g().init(this, b[n], f[t])),
              p && ((p.index = n), (B[t] = p));
          this.options.keys = a;
          if (d && (l !== (e = d.length) || x))
            for (t = 0; t < e; t++)
              t !== k || x || (t += l),
                d[t] && (d[t].destroyElements(), (d[t].plotX = void 0));
          this.data = d;
          this.points = B;
        ...
        getExtremes: function (a) {
          ...
          for (B = 0; B < c; B++)
            if (
              ...
              (u =
                (l(p, !0) || e(p)) &&
                (!b.positiveValuesOnly || p.length || 0 < p)),
              (r =
        ...
        translate: function () {
          ...
          for (u = 0; u < k; u++) {
            ...
            var N =
                d &&
                f.stacks[
                  (this.negStacks && Q < (B ? 0 : p) ? "-" : "") + this.stackKey
                ],
              V;
            ...
            F.plotX = t = c(
              Math.min(
                Math.max(
                  -1e5,
                  e.translate(I, 0, 0, 0, 1, r, "flags" === this.type)
                ),
                1e5
              )
            );
            ...
            F.yBottom = v(E)
              ? Math.min(Math.max(-1e5, f.translate(E, 0, 1, 0, 1)), 1e5)
              : null;
        ...
        setClip: function (a) {
          ...
          !1 !== d.clip &&
            (this.group.clip(a || c ? m : b.clipRect),
        ...
        animate: function (a) {
          ...
          a
            ...
            : ((e = this.sharedClipKey),
              ...
              b[e + "m"] &&
                b[e + "m"].animate({ width: b.plotSizeX + 99, x: 0 }, d),
              (this.animate = null));
        },
                  ...
                  ? ((f = b(l.symbol, this.symbol)),
                    ...
                    g
                      ...
                      : n &&
                        ...
                        (c.graphic = g =
                          d.renderer
                            .symbol(f, r.x, r.y, r.width, r.height, k ? l : h)
                            .add(u)),
                    g &&
                      !d.styledMode &&
        ...
        pointAttribs: function (a, d) {
          ...
          d &&
            ...
            (c = b(
              d.lineWidth,
              e.lineWidth,
              c + b(d.lineWidthPlus, e.lineWidthPlus, 0)
            )),
        ...
        destroy: function (b) {
          ...
          (d.axisTypes || []).forEach(function (a) {
            (n = d[a]) &&
              n.series &&
              (w(n.series, d), (n.isDirty = n.forceRedraw = !0));
          });
        ...
        applyZones: function () {
          ...
          c.length &&
            ...
            c.forEach(function (c, m) {
              ...
              g = Math.min(
                Math.max(Math.round(r.toPixels(b(c.value, x.max), !0) || 0), 0),
                u
              );
              ...
              w = Math.max(f, g);
              r.isXAxis
                ? ((l = { x: B ? w : E, y: 0, width: v, height: u }),
                  t || (l.x = d.plotHeight - l.x))
                : ((l = { x: 0, y: B ? w : E, width: u, height: v }),
    ...
    a.StackItem.prototype = {
      ...
      setOffset: function (a, c) {
        ...
        (c = this.label) &&
          ...
          (e = c.alignAttr),
          c[
            !1 === this.options.crop || h.isInsidePlot(e.x, e.y)
              ? "show"
              : "hide"
          ](!0));
      },
          ...
          (w = c[q]),
            ...
            null !== y
              ? ((A.points[f] = A.points[this.index] = [v(A.cumulative, g)]),
                ...
                0 < z.index &&
                  !1 === this.singleStacks &&
                  (A.points[f][0] = A.points[this.index + "," + w + ",0"][0]))
  ...
  (function (a) {
    ...
    w(k.prototype, {
      ...
      update: function (b, e, c, l) {
        ...
        d(b, function (a, b) {
          ...
          "chart" !== b &&
            -1 !== m.propsRequireUpdateSeries.indexOf(b) &&
            (p = !0);
        });
        ...
        u = k && k.width;
        k = k && k.height;
        (h(u) && u !== m.chartWidth) || (h(k) && k !== m.chartHeight)
          ? m.setSize(u, k, l)
          : g(e, !0) && m.redraw(l);
    ...
    w(b.prototype, {
      update: function (a, b, d, c) {
        function h() {
          ...
          u.data[k] =
            e(u.data[k], !0) || e(a, !0) ? f.options : g(a, u.data[k]);
      ...
      update: function (b, d) {
        ...
        if (E)
          ...
          b = n(
            h,
            t,
            { index: e.index, pointStart: g(h.pointStart, e.xData[0]) },
            { data: e.options.data },
            b
          );
          e.remove(!1, null, !1, !0);
    ...
    w(G.prototype, {
      ...
      remove: function (a) {
        for (
          var b = this.chart, d = this.coll, e = this.series, c = e.length;
          c--;
        ...
        getGraphPath: function (a) {
          ...
          for (r = 0; r < a.length; r++)
            if (
              ...
              k || H(r, r - 1, "left"),
                (h && !v && k) ||
                  (l.push(a[r]), e.push({ x: r, plotX: d, plotY: u })),
                k || H(r, r + 1, "right");
          r = c.call(this, l, !0, !0);
          e.reversed = !0;
          h = c.call(this, e, !0, !0);
            ...
            h
              ...
              : ((h = { zIndex: 0 }),
                a.chart.styledMode ||
                  (h.fill = F(
                    c[3],
                    y(c[2]).setOpacity(F(t.fillOpacity, 0.75)).get()
                  )),
                (h = a[p] =
                  a.chart.renderer.path(k).addClass(c[1]).attr(h).add(a.group)),
                (h.isArea = !0));
            h.startX = k.xMap;
    ...
    a(
      ...
      {},
      {
        getPointSpline: function (a, G, k) {
          ...
          G = [
            "C",
            y(t.rightContX, t.plotX),
            y(t.rightContY, t.plotY),
            y(v, c),
            y(w, p),
            c,
            p,
      ...
      },
      {
        ...
        getColumnMetrics: function () {
          ...
          var u = Math.min(
            ...
            v = (u - 2 * r) / (p || 1),
            e = Math.min(
              e.maxPointWidth || c.len,
              t(e.pointWidth, v * (1 - 2 * e.pointPadding))
            );
          a.columnMetrics = {
            width: e,
            offset:
              (v - e) / 2 +
              (r + ((a.columnIndex || 0) + (d ? 1 : 0)) * v - u / 2) *
                (d ? -1 : 1),
          };
        ...
        crispCol: function (a, e, c, k) {
          ...
          this.options.crisp &&
            ((c = Math.round(a + c) + b), (a = Math.round(a) + b), (c -= a));
          k = Math.round(e + k) + g;
        ...
        drawPoints: function () {
          ...
          a.points.forEach(function (b) {
            ...
            if (c(b.plotY) && null !== b.y) {
              ...
              e.styledMode ||
                h[l](a.pointAttribs(b, b.selected && "select")).shadow(
                  k.shadow,
                  null,
          ...
          r &&
            (a
              ? ((g.scaleY = 0.001),
                (a = Math.min(
                  c.pos + c.len,
                  Math.max(c.pos, c.toPixels(h.threshold))
                )),
      ...
      },
      {
        ...
        getX: function (a, c, h) {
          ...
          return (
            ...
            (c ? -1 : 1) *
              Math.cos(
                Math.asin(
                  Math.max(Math.min((a - d[1]) / (e + h.labelDistance), 1), -1)
                )
              ) *
              (e + h.labelDistance) +
            (0 < h.labelDistance
        ...
        drawPoints: function () {
          ...
          !u ||
            a.shadowGroup ||
            c.styledMode ||
            (a.shadowGroup = h.g("shadow").add(a.group));
          a.points.forEach(function (e) {
            ...
            if (e.isNull) g && (e.graphic = g.destroy());
              ...
              if (!c.styledMode) {
                ...
                u &&
                  !l &&
                  (l = e.shadowGroup = h.g("shadow").add(a.shadowGroup));
                l && l.attr(d);
        ...
        haloPath: function (a) {
          ...
          return this.sliced || !this.visible
            ...
            : this.series.chart.renderer.symbols.arc(
                ...
                e.r + a,
                e.r + a,
                { innerR: this.shapeArgs.r - 1, start: e.start, end: e.end }
              );
        },
        connectorShapes: {
  ...
  (function (a) {
      ...
      for (
        ...
        for (k = !1; h--; )
          0 < h &&
            ...
            (d[h - 1].align = 0.5),
            d[h - 1].pos + d[h - 1].size > c &&
              (d[h - 1].pos = c - d[h - 1].size),
            d.splice(h, 1),
            (k = !0));
      }
      l.push.apply(l, n);
          ...
          t.forEach(function (f) {
            ...
            w.forEach(function (e, g) {
              ...
              m &&
                ...
                (l = G(n)
                  ? c(n, l, h.time)
                  : (e[f.formatPrefix + "Formatter"] || e.formatter).call(
                      l,
                      e
                    )),
                (n = e.style),
                ...
                h.styledMode ||
                  ...
                  "contrast" === n.color &&
                    ...
                    (n.color =
                      e.inside ||
                      0 > v(e.distance, f.labelDistance) ||
                      k.stacking
                        ? f.contrastColor
                        : "#000000")),
    ...
    r.prototype.alignDataLabel = function (a, e, b, c, h) {
      ...
      if (
        q &&
        ((u = d.renderer.fontMetrics(
          d.styledMode ? void 0 : b.style.fontSize,
          e
        ).b),
        (c = k(
          {
          ...
          ? ((r = !1),
            ...
            (l = {
              ...
              y:
                c.y +
                b.y +
                { top: 0, middle: 0.5, bottom: 1 }[b.verticalAlign] * c.height,
            }),
        ...
        r && 0 <= c.height
          ...
          : v(b.crop, !0) &&
            (q =
              d.isInsidePlot(l.x, l.y) &&
              d.isInsidePlot(l.x + n.width, l.y + n.height)),
        b.shape && !p)
      )
        e[h ? "attr" : "animate"]({
    ...
    r.prototype.justifyDataLabel = function (a, e, b, c, h, k) {
      ...
      l = b.x + c.width - u;
      l > d.plotWidth &&
        ("left" === g ? (e.align = "right") : (e.x = d.plotWidth - l),
        (n = !0));
      l = b.y + u;
      0 > l &&
        ("bottom" === m ? (e.verticalAlign = "top") : (e.y = -l), (n = !0));
      l = b.y + c.height - u;
      l > d.plotHeight &&
        ("top" === m ? (e.verticalAlign = "bottom") : (e.y = d.plotHeight - l),
        (n = !0));
          ...
          R.forEach(function (e, g) {
            ...
            if (r)
              for (
                ...
                K._pos = {
                  x: C + h.x + ({ left: k, right: -k }[J.alignment] || 0),
                  y: P + h.y - 10,
                };
                J.final.x = C;
                J.final.y = P;
                v(h.crop, !0) &&
                  ...
                  C - I < k && 1 === g
                    ...
                    : C + I > n - k &&
                      0 === g &&
                      ((l = Math.round(C + I - n + k)),
                      (O[1] = Math.max(l, O[1]))),
                  0 > P - M / 2
                    ? (O[0] = Math.max(Math.round(-P + M / 2), O[0]))
                    : P + M / 2 > m &&
                      (O[2] = Math.max(Math.round(P + M / 2 - m), O[2])),
                  (K.sideOverflow = l));
              }
          }),
      ...
      (h.pie.prototype.verifyDataLabelOverflow = function (a) {
        ...
        k ||
          (null !== e[0]
            ...
            : ((h = Math.max(d[2] - a[1] - a[3], c)),
              (d[0] += (a[3] - a[1]) / 2)),
          null !== e[1]
            ? (h = Math.max(Math.min(h, d[2] - Math.max(a[0], a[2])), c))
            : ((h = Math.max(Math.min(h, d[2] - a[0] - a[2]), c)),
              (d[1] += (a[0] - a[2]) / 2)),
          h < d[2]
            ? ((d[2] = h),
    ...
    h.column &&
      (h.column.prototype.alignDataLabel = function (a, e, b, c, h) {
        ...
        k &&
          ...
          n ||
            (d
              ? ((c.x += l ? 0 : c.width), (c.width = 0))
              : ((c.y += l ? c.height : 0), (c.height = 0))));
        b.align = v(b.align, !d || n ? "center" : l ? "right" : "left");
        b.verticalAlign = v(
          b.verticalAlign,
          d || n ? "middle" : l ? "top" : "bottom"
        );
  ...
  (function (a) {
    ...
    t(F.prototype, {
      ...
      zoom: function (a) {
        ...
        d && !e
          ? this.showResetZoom()
          : !d && r(e) && (this.resetZoomButton = e.destroy());
        b &&
          this.redraw(
            l(
            ...
            this.state &&
              ...
              w.styledMode ||
                this.graphic.animate(
                  ...
                  l(w.options.chart.animation, g.animation)
                ),
              y &&
                this.graphic.animate(
                  y,
                  l(w.options.chart.animation, f.animation, h.animation)
                ),
              r && r.hide();
          else {
            if (a && f) {
              ...
              if (r) r[b ? "animate" : "attr"]({ x: y.x, y: y.y });
                ...
                h &&
                  ((e.stateMarkerGraphic = r =
                    w.renderer
                      .symbol(h, y.x, y.y, y.width, y.height)
                      .add(e.markerGroup)),
                  (r.currentSymbol = h));
              !w.styledMode && r && r.attr(e.pointAttribs(this, a));
            }
            r &&
              (r[a && w.isInsidePlot(c, d, w.inverted) ? "show" : "hide"](),
              (r.element.point = this));
          }
          (c = g.halo) && c.size
            ? (x ||
                (e.halo = x =
                  w.renderer.path().add((this.graphic || r).parentGroup)),
      ...
      setState: function (a) {
        ...
        if (
          ...
          !(b.chart.styledMode || (e[a] && !1 === e[a].enabled)) &&
            (a && (g = e[a].lineWidth || g + (e[a].lineWidthPlus || 0)),
            d && !d.dashstyle))
        )
          for (
            g = { "stroke-width": g },
