        ...
        if (b)
          for (
            ...
            b[d] && this.axis
              ...
              : this.background[d] &&
                ((this.background[d] = this.background[d].destroy()),
    ...
    a.radialAxisExtended ||
      ...
      (t = {
        ...
        getLinePath: function (l, n) {
          ...
          this.isCircular || void 0 !== n
            ? ((n = this.chart.renderer.symbols.arc(
                this.left + l[0],
                this.top + l[1],
                k,
                k,
        ...
        setAxisSize: function () {
          ...
          this.isRadial &&
            ...
            (this.len =
              this.width =
              this.height =
                (this.center[2] * p(this.sector, 1)) / 2));
        },
        getPosition: function (l, n) {
          return this.postTranslate(
            this.isCircular ? this.translate(l) : this.angleRad,
            p(this.isCircular ? n : this.translate(l), this.center[2] / 2) -
              this.offset
          );
        },
        ...
        getPlotBandPath: function (l, n, f) {
          ...
          "polygon" === this.options.gridLineInterpolation
            ...
            : ((l = Math.max(l, this.min)),
              ...
              (a[0] -= e),
              (a[2] -= e),
              (k = this.chart.renderer.symbols.arc(
                this.left + k[0],
                this.top + k[1],
                a[0],
                a[0],
        ...
        getTitlePosition: function () {
          ...
          return {
            ...
            y:
              c.plotTop +
              l[1] -
              { high: 0.5, middle: 0.25, low: 0 }[f.align] * l[2] +
              (f.y || 0),
          };
        },
      }),
      ...
      w(x, "afterInit", function () {
        ...
        (c.angular && this.isXAxis) ||
          ...
          (this.endAngleRad =
            ((p(k.endAngle, k.startAngle + 360) - 90) * Math.PI) / 180),
      ...
      w(d, "afterGetLabelPosition", function (c) {
        ...
        a.isRadial &&
          ...
          "auto" === k.rotation
            ...
            : null === l &&
              (l =
                a.chart.renderer.fontMetrics(f.styles && f.styles.fontSize).b -
                f.getBBox().height / 2),
          null === e &&
            (a.isCircular
              ? (this.label.getBBox().width >
                  (a.len * a.tickInterval) / (a.max - a.min) && (m = 0),
                (e =
                  v > m && v < 180 - m
                    ? "left"
                    : v > 180 + m && v < 360 - m
      ...
      e(m, "getMarkPath", function (c, a, f, k, b, m, e) {
        var l = this.axis;
        l.isRadial
          ? ((c = l.getPosition(this.pos, l.center[2] / 2 + k)),
            (a = ["M", a, f, "L", c.x, c.y]))
    ...
    u(
      ...
      },
      {
        ...
        getGraphPath: function (a) {
          ...
          d &&
            (!0 === d && (d = "left"),
            (n.step = { left: "right", center: "center", right: "left" }[d]));
          c = v.call(this, c);
          b = v.call(this, b);
          n.step = d;
          n = [].concat(a, c);
        ...
        drawDataLabels: function () {
          ...
          if (f.enabled)
            for (d = c; d--; )
              if ((m = a[d]))
                m.dataLabels = [m.dataLabelUpper, m.dataLabel].filter(function (
                  f
                ) {
                  return !!f;
                });
        ...
        translate: function () {
          ...
          a.points.forEach(function (b) {
            var f = b.shapeArgs,
              ...
              n,
              y;
            b.plotHigh = l = Math.min(
              Math.max(-m, d.translate(b.high, 0, 1, 0, 1)),
              m
            );
            ...
            v
              ...
              : ((f.height = n),
                ...
                (b.tooltipPos = t.inverted
                  ? [
                      d.len + d.pos - t.plotLeft - y - n / 2,
                      e.len + e.pos - t.plotTop - f.x - f.width / 2,
                      n,
                    ]
                  : [
                      e.left - t.plotLeft + f.x + f.width / 2,
                      d.pos - t.plotTop + y + n / 2,
                      n,
                    ]));
          });
        },
          ...
          this.points.forEach(function (d) {
            ...
            w(k)
              ? ((k = (k / 180) * Math.PI),
                (C = Math.max(
                  a.startAngleRad - k,
                  Math.min(a.endAngleRad + k, C)
                )))
              : !1 === b.wrap &&
                (C = Math.max(a.startAngleRad, Math.min(a.endAngleRad, C)));
            C = (180 * C) / Math.PI;
            d.shapeType = "path";
            d.shapeArgs = {
              d: e.path || [
            ...
            (f = d[c]),
              ...
              x
                ? E &&
                  ((r = E[c]),
                  "overlap" === x
                    ? ((e = r.threshold + r.total),
                      (r.total -= A),
                      (e = 0 <= A ? e : e - A))
                    : 0 <= A
                    ? ((e = r.threshold + r.posTotal), (r.posTotal -= A))
                    : ((e = r.threshold + r.negTotal),
                      (r.negTotal -= A),
                      (e -= A)),
                  f.isSum ||
                ...
                : ((e = Math.max(h, h + A) + r[0]),
                  ...
                  f.isSum
                    ? ((k.y = b.translate(r[1], 0, 1, 0, 1)),
                      (k.height =
                        Math.min(b.translate(r[0], 0, 1, 0, 1), b.len) - k.y))
                    : f.isIntermediateSum
                    ? (0 <= A
                        ? ((y = r[1] + q), (A = q))
                        : ((y = q), (A = r[1] + q)),
                      ...
                      (k.y = b.translate(y, 0, 1, 0, 1)),
                      (k.height = Math.abs(
                        k.y - Math.min(b.translate(A, 0, 1, 0, 1), b.len)
                      )),
                      (q += r[1]))
                    : ((k.height =
                        0 < y
        ...
        getCrispPath: function () {
          ...
          for (w = 1; w < c; w++) {
            ...
            g &&
              ((g = g[w - 1]),
              h
                ? ((g = g.connectorThreshold),
                  (t =
                    Math.round(b.translate(g, 0, 1, 0, 1) + (e ? t : 0)) - d))
  ...
  (function (a) {
    ...
    x(
      ...
      },
      {
        ...
        getGraphPath: function () {
          for (
            var a = w.prototype.getGraphPath.call(this), g = a.length + 1;
            g--;
  ...
  (function (a) {
    ...
    a.BubbleLegend.prototype = {
        ...
        b.forEach(function (f, k) {
          q ||
            ...
            (g.fill = t(
              f.color,
              d.color,
              1 !== n ? p(e.color).setOpacity(n).get("rgba") : e.color
            )),
      ...
      render: function () {
        ...
        a.symbols ||
          (a.symbols = { connectors: [], bubbleItems: [], labels: [] });
      ...
      renderRange: function (a) {
        var b = this.options,
          ...
          p = f.styledMode;
        "center" === h &&
          ((m = 0), (b.connectorDistance = 0), (a.labelStyle.align = "center"));
        h = v + b.labels.y;
        t = q + m + b.labels.x;
        d.bubbleItems.push(
          f
      ...
      this.allItems.forEach(function (l, k) {
        ...
        if ((d = l.movementX) || (f && l.ranges))
          (d = f ? b - l.options.maxSize / 2 : b + d),
            l.legendGroup.attr({ translateX: d });
        k > a[e].step && e++;
      ...
      f
        ...
        : (a.call(this, b, c),
          d &&
            d.options.enabled &&
            d.bubbleLegend &&
            (d.render(), d.retranslateItems(d.getLinesHeights())));
    });
  })(z);
  (function (a) {
    var w = a.arrayMax,
      ...
      },
      {
        ...
        getRadii: function (a, b, c) {
          ...
          for (c = f.length; d < c; d++)
            (g = f[d]), m.push(this.getRadius(a, b, e, l, g));
          this.radii = m;
        },
    ...
    w(
      ...
      },
      {
        ...
        translate: function () {
          ...
          this.generatePoints();
          x(h.allDataPoints) ||
            ((h.allDataPoints = this.accumulateAllPoints(this)),
            this.getPointRadius());
        ...
        positionBubble: function (a, h, u) {
          ...
          a =
            (0 > a[1] - h[1] ? 0 : Math.PI) +
            d +
            b * (0 > (a[0] - h[0]) * (a[1] - h[1]) ? 1 : -1);
          return [
            h[0] + (h[2] + u[2]) * Math.sin(a),
            h[1] - (h[2] + u[2]) * Math.cos(a),
            u[2],
            u[3],
            u[4],
          ];
  ...
  (function (a) {
    ...
    a.polarExtended ||
      ...
      g.spline &&
        ...
        g.areasplinerange &&
          (g.areasplinerange.prototype.getPointSpline =
            g.spline.prototype.getPointSpline)),
      a.addEvent(
        x,
        "afterTranslate",
        function () {
              ...
              (this.hasClipCircleSetter = !!a.addEvent(
                ...
                function () {
                  ...
                  b.polar &&
                    ((c = this.yAxis.center),
                    this.group.clip(
                      b.renderer.clipCircle(c[0], c[1], c[2] / 2)
                    ),
                    (this.setClip = a.noop));
                }
              ));
